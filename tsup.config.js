...
export default defineConfig({
  entry: {
    ...
    vue: 'src/folder-gallery-vue.js',         // Vue 3 wrapper (vue = peer dep)
  },
  external: ['react', 'vue'],
  ...
  onSuccess:
    'cp src/folder-gallery.d.ts dist/index.d.ts && cp src/folder-gallery-element.d.ts dist/element.d.ts && cp src/folder-gallery-react.d.ts dist/react.d.ts && cp src/folder-gallery-vue.d.ts dist/vue.d.ts && cp src/folder-gallery.css dist/folder-gallery.css',
});
